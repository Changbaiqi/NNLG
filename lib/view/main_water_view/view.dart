...
class MainWaterViewPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: CustomerThemeUtil.setColor(CustomThemeData.nowThemeData.value['main_water_view']!['backgroundColor'] as List),
      resizeToAvoidBottomInset: false,
      endDrawer: Drawer(
          width: 200,
          child: Center(
            child: Text('加载中...',style: TextStyle(color: CustomerThemeUtil.setColor(CustomThemeData.nowThemeData.value['main_water_view']!['textColor'] as List)),),
          )),
                    ...
                    child: Card(
                      ...
                      child: Obx(() => Column(
                            children: [
                              ...
                              Text('当前所选设备编号：${state.divice.value ?? "未知"}',style: TextStyle(color: CustomerThemeUtil.setColor(CustomThemeData.nowThemeData.value['main_water_view']!['textColor'] as List)),),
                      ...
                      child: Column(
                        children: [
                          Container(
                            width: 100,
                            child: Row(
                              children: [Icon(Icons.cloud_download),Text('数据同步中',style: TextStyle(color: CustomerThemeUtil.setColor(CustomThemeData.nowThemeData.value['main_water_view']!['textColor'] as List)),)],
                            ),
                          )
                        ],
                      ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Obx(
            () => Text(
                '账号：${state.bingCard.value.isEmpty ? "未绑定" : state.bingCard.value}',style: TextStyle(color: CustomerThemeUtil.setColor(CustomThemeData.nowThemeData.value['main_water_view']!['textColor'] as List)),),
          ),
          Row(
            children: [
              Visibility(
