                ...
                children: [
                  Container(
                    ...
                    child: Card(
                      child: Obx(()=>Column(
                        children: [
                          Text('${(state.money.value==""||state.money.value==null)?"0.00":state.money.value}￥',style: TextStyle(fontSize: 50,color: Colors.orange),),
  ...
  Widget bingAccount(){
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Obx(() => Text('账号：${state.bingCard.value.isEmpty?"未绑定":state.bingCard.value}'),),
          Row(
            children: [
              Visibility(
                  visible: WaterData.waterAccount.value.isEmpty|| WaterData.waterAccount.value=="" ? false : true, //检查账号是否为空
                  ...
                  onPressed: (){
                    if( WaterData.waterAccount.value.isEmpty){
                      ...
                      ShareDateUtil().setWaterUnBind().then((value){
                        ...
                        Get.snackbar("提示", "解绑成功",duration: Duration(milliseconds: 1500));
                      });
                    }

                  }
                  , child: Obx(()=>Text('${WaterData.waterAccount.value.isEmpty ? "绑定" : "解绑"}')))
            ],
          )
